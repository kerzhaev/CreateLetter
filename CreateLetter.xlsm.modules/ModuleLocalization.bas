...
Private Sub LoadBuiltInLocalization()
    ...
    AddTranslation "ru", "form.letter_creator.label.address_group", "Группа адреса"
    ...
    AddTranslation "ru", "form.letter_creator.msg.address_select_error", "Ошибка при выборе адреса: "

    AddTranslation "en", "form.letter_creator.msg.address_select_error", "Error selecting address: "
    ...
    AddTranslation "ru", "postal.registry.print.footer.date_blank", "«___» __________ 202__ года"
    AddTranslation "en", "postal.registry.print.footer.date_blank", """___"" __________ 202__ year"
    ...
    AddTranslation "ru", "postal.registry.settings.title", "Настройки печатного реестра"
    AddTranslation "en", "postal.registry.settings.title", "Postal registry settings"
    AddTranslation "ru", "postal.registry.settings.prompt.post_office", "Почтовое отделение:"
    AddTranslation "en", "postal.registry.settings.prompt.post_office", "Post office name:"
    AddTranslation "ru", "postal.registry.settings.prompt.sender_signature", "Подпись отправителя:"
    AddTranslation "en", "postal.registry.settings.prompt.sender_signature", "Sender signature name:"
    AddTranslation "ru", "postal.registry.settings.prompt.receiver_signature", "Подпись приёмщика:"
    AddTranslation "en", "postal.registry.settings.prompt.receiver_signature", "Receiver signature name:"
    AddTranslation "ru", "postal.registry.settings.prompt.pdf_folder", "Выберите папку для PDF-реестров"
    AddTranslation "en", "postal.registry.settings.prompt.pdf_folder", "Select PDF export folder"
    AddTranslation "ru", "postal.registry.settings.msg.saved", "Настройки печатного реестра сохранены."
    ...
    AddTranslation "ru", "dispatch.journal.title", "Журнал отправлений"
    AddTranslation "en", "dispatch.journal.title", "Dispatch journal"
    AddTranslation "ru", "dispatch.journal.return.title", "Возврат пакета в работу"
    AddTranslation "en", "dispatch.journal.return.title", "Return package to work"
    AddTranslation "ru", "dispatch.journal.prompt.batch_id", "Выберите строку пакета в журнале/реестре или введите BatchId вручную:"
    AddTranslation "en", "dispatch.journal.prompt.batch_id", "Select a package row in DispatchJournal or DispatchRegistry, or enter BatchId manually:"
    AddTranslation "ru", "dispatch.journal.return.confirm", "Вернуть этот пакет в доступные письма?"
    AddTranslation "en", "dispatch.journal.return.confirm", "Return this package to available letters?"
    AddTranslation "ru", "dispatch.journal.return.msg.done", "Пакет возвращён в доступные письма."
    AddTranslation "en", "dispatch.journal.return.msg.done", "Package returned to available letters."
    AddTranslation "ru", "dispatch.journal.return.msg.not_found", "Пакет не найден."
    AddTranslation "en", "dispatch.journal.return.msg.not_found", "Package was not found."
    AddTranslation "ru", "dispatch.journal.return.msg.error", "Не удалось вернуть пакет: "
    AddTranslation "en", "dispatch.journal.return.msg.error", "Failed to return package: "
    AddTranslation "ru", "dispatch.journal.return.error.printed", "Пакеты, уже напечатанные в PDF-реестре, нельзя возвращать в работу."
    AddTranslation "en", "dispatch.journal.return.error.printed", "Printed packages cannot be returned to work."
    AddTranslation "ru", "dispatch.journal.msg.no_items", "Почтовые пакеты не найдены."
    ...
    AddTranslation "en", "dispatch.journal.column.status", "Status"
    AddTranslation "ru", "dispatch.journal.column.registry_number", "Номер реестра"
    AddTranslation "en", "dispatch.journal.column.registry_number", "Registry number"
    AddTranslation "ru", "dispatch.journal.column.registry_date", "Дата реестра"
    AddTranslation "en", "dispatch.journal.column.registry_date", "Registry date"
    AddTranslation "ru", "dispatch.journal.column.addressee", "Адресат"
    AddTranslation "en", "dispatch.journal.column.addressee", "Addressee"
    AddTranslation "ru", "dispatch.journal.column.letter_count", "Писем"
    AddTranslation "en", "dispatch.journal.column.letter_count", "Letters"
    AddTranslation "ru", "dispatch.journal.column.outgoing_numbers", "Исходящие номера"
    AddTranslation "en", "dispatch.journal.column.outgoing_numbers", "Outgoing numbers"
    AddTranslation "ru", "dispatch.journal.column.sender", "Отправитель"
    AddTranslation "en", "dispatch.journal.column.sender", "Sender"
    AddTranslation "ru", "dispatch.journal.column.envelope_format", "Конверт"
    AddTranslation "en", "dispatch.journal.column.envelope_format", "Envelope"
    AddTranslation "ru", "dispatch.journal.column.mail_type", "Вид отправления"
    AddTranslation "en", "dispatch.journal.column.mail_type", "Mail type"
    AddTranslation "ru", "dispatch.journal.column.created_at", "Создано"
    AddTranslation "en", "dispatch.journal.column.created_at", "Created at"
    AddTranslation "ru", "dispatch.journal.column.comment", "Комментарий"
    AddTranslation "en", "dispatch.journal.column.comment", "Comment"
