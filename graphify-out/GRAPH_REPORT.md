# Graph Report - CreateLetter  (2026-05-03)

## Corpus Check
- 21 files · ~35,183 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 93 nodes · 159 edges · 8 communities detected
...
Cohesion: 0.29
Nodes (14): build_parser(), ensure_address_group_column(), ensure_envelope_formats_seed(), ensure_layout_sheet(), ensure_print_sheet(), ensure_program_settings_seed(), ensure_sheet_headers(), ensure_table() (+6 more)
