...
## Corpus Check
- 20 files · ~32,116 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 83 nodes · 147 edges · 7 communities detected
...
Cohesion: 0.52
Nodes (6): build_parser(), get_or_create_sheet(), main(), parse_translations(), reset_excel_gen_cache(), write_localization_sheet()
...
## Knowledge Gaps
- **Thin community `Community 6`** (7 nodes): `Add-Result()`, `Get-TableColumnNames()`, `Get-WorksheetTableNames()`, `Test-DocumentModuleSourceCoverage()`, `Test-WorksheetVariants()`, `run_excel_smoke_test.ps1`, `run_excel_smoke_test.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `remove_invalid_print_area_aliases()` connect `Community 3` to `Community 1`, `Community 5`?**
