# Graph Report - CreateLetter  (2026-05-06)

## Corpus Check
- 21 files · ~35,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 98 nodes · 167 edges · 8 communities detected
...
- `sync_workbook()` --calls--> `get_excel_open_path()`  [EXTRACTED]
...
Cohesion: 0.27
Nodes (15): build_parser(), ensure_address_group_column(), ensure_envelope_formats_seed(), ensure_layout_sheet(), ensure_print_sheet(), ensure_program_settings_seed(), ensure_sheet_headers(), ensure_table() (+7 more)

### Community 1 - "Community 1"
Cohesion: 0.34
Nodes (13): build_parser(), derive_document_modules_dir(), extract_existing_userform_code(), get_component_by_name(), get_excel_open_path(), iter_source_files(), main(), read_source_text() (+5 more)
...
Cohesion: 0.31
Nodes (9): build_parser(), clear_dynamic_content(), clear_shapes(), import_template(), main(), reset_excel_gen_cache(), build_parser(), main() (+1 more)
...
Cohesion: 0.46
Nodes (7): build_parser(), get_excel_open_path(), get_or_create_sheet(), main(), parse_translations(), reset_excel_gen_cache(), write_localization_sheet()
...
## Knowledge Gaps
- **Thin community `Community 7`** (8 nodes): `Add-Result()`, `Get-ExcelOpenPath()`, `Get-TableColumnNames()`, `Get-WorksheetTableNames()`, `Test-DocumentModuleSourceCoverage()`, `Test-WorksheetVariants()`, `run_excel_smoke_test.ps1`, `run_excel_smoke_test.ps1`
...
- **Why does `main()` connect `Community 6` to `Community 3`?**
